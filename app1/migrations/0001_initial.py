# Generated by Django 3.2.18 on 2023-03-14 11:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(help_text='The Book that this review is for.', on_delete=django.db.models.deletion.CASCADE, to='app1.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.contributor')),
            ],
        ),
        migrations.AddField(
            model_name='book',
            name='contributors',
            field=models.ManyToManyField(through='app1.BookContributor', to='app1.Contributor'),
        ),
        migrations.AddField(
            model_name='book',
            name='publisher',
